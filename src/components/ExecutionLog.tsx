              ...
              <div
                className={`absolute -left-[31px] sm:-left-[47px] top-2.5 w-3.5 h-3.5 rounded-full border transition-all duration-200 ${
                  isExpanded
                    ...
                    : 'bg-[#090A0E] border-white/20 group-hover:border-white/60'
                }`}
              />

              {/* Glass Card */}
              <div className="glass-panel glass-panel-hover rounded-xl border border-white/[0.08] p-5 sm:p-6 transition-all duration-200">
                <div
                ...
                >
                  <div>
                    ...
                    <div className="text-sm font-mono text-amber-200/90 font-medium flex items-center gap-1.5 mt-0.5">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {exp.skills.map((skill) => (
                          <span
                            key={skill}
                            className="px-2 py-0.5 bg-[#090A0E] border border-white/[0.08] text-slate-300 text-xs font-mono rounded"
                          >
                            {skill}
                          </span>
                        ))}
